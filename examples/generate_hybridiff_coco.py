...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--L_slope", type=int, default=12)
    parser.add_argument("--eps_slope", type=float, default=0.4e-3)
    parser.add_argument("--k", type=int, default=5)
    parser.add_argument("--tau_cap", type=int, default=15)
...
def main():
    ...
    if args.output_root is None:
        args.output_root = os.path.join(
            f"results-hybridiff-{args.model_n}gpu-{args.stride}stride",
            "coco",
